...
setInterval(() => {
  http.get(`http://kmusic-v1-6.glitch.me/`);
}, 280000);
...
client.login(process.env.TOKEN).catch(err=> console.log("قد لايوجد توكن او التوكن متوقف . [KAHv1.6]"));
...
let c = g.channels.get("694595613609951295");// id channel
if(c.type === 'voice') {
c.join();
setInterval(() => {
